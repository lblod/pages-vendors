...
;define("pages-vendors/templates/docs/mandaten-annotaties", ["exports", "@ember/template-factory"], function (_exports, _templateFactory) {
  "use strict";
  ...
  <p>Het lokaal mandatenbeheer biedt verschillende LDES streams aan. Meer
    ...
    >de source code documentatie.</a></p>
  
  <AuHeading @level="2" @skin="2">Secure SPARQL endpoint</AuHeading>
  <p>Het lokaal mandatenbeheer biedt een secure sparql endpoint aan op de url
    <a
    ...
    deze aan te vragen staat beschreven in de documentatie van Loket.</p>
  
  <AuHeading @level="2" @skin="2">Automatische doorstroom van informatie</AuHeading>
  <p>De informatie beheerd in lokaal mandatenbeheer stroomt automatisch voort naar
    Loket en van daar naar de Mandatendatabank en de centrale vindplaats.
    Mandatarissen in de draft status stromen niet automatisch door.</p>
  <p>Gevoelige persoonsgegevens als rijksregisternummers, geslachten en
    geboortedatums stromen ook niet door.</p>
  ...
  <AuHeading @level="4" @skin="4">Klasse</AuHeading>
  <p>
    <CodeInline @code="besluit:Besluit" />
  </p>
  <AuHeading @level="4" @skin="4">Beschrijving</AuHeading>
  <p>
    ...
    <CodeInline @code="besluit:Rechtsgrond" />. Enkel de eigenschappen die
  ...
  <AuTable>
    ...
    <:body>
      <tr>
        ...
        <td><CodeInline @code="mandaat:bekrachtigtAanstellingVan" /></td>
        <td><CodeInline @code="mandaat:Mandataris" /></td>
      ...
      <tr>
        ...
        <td><CodeInline @code="mandaat:bekrachtigtOntslagVan" /></td>
        <td><CodeInline @code="mandaat:Mandataris" /></td>
  ...
  <p>
    ...
    <CodeInline @code="besluit:isTijdspecialisatieVan" />
    waarmee een Bestuursorgaan in de tijd verwijst naar zijn bestuursorgaan.
    Daarnaast wordt de
    <CodeInline @code="besluit:classificatie" />
    enkel gespecificeerd op een Bestuursorgaan, niet op een Bestuursorgaan in de
    tijd. Een Bestuursorgaan in de tijd heeft een
    <CodeInline @code="mandaat:bindingStart" />
    en een
    <CodeInline @code="mandaat:bindingEinde" />. Deze eigenschappen geven aan
    wanneer het Bestuursorgaan in de tijd actief is. Indien een Bestuursorgaan in
    de tijd geen
    <CodeInline @code="mandaat:bindingEinde" />
    ...
    <CodeInline @code="mandaat:Mandaat" />. Dat betekent dus ook dat de URI van
    bijvoorbeeld een burgemeester mandaat verandert per bestuursperiode. De
    classificatie code (<CodeInline @code="org:role" />) blijft wel dezelfde
    uiteraard.
  </p>
  <AuHeading @level="4" @skin="4">Eigenschappen</AuHeading>
  <AuTable>
    ...
    <:body>
      <tr>
        <td>bevat</td>
        <td><CodeInline @code="org:hasPost" /></td>
        <td><CodeInline @code="mandaat:Mandaat" /></td>
      ...
      <tr>
        <td>bindingStart</td>
        <td><CodeInline @code="mandaat:bindingStart" /></td>
        <td><CodeInline @code="xsd:dateTime" /></td>
        <td>Het tijdstip waar op dit Bestuursorgaan in de tijd actief wordt/werd.</td>
      </tr>
      <tr>
        <td>bindingEinde</td>
        <td><CodeInline @code="mandaat:bindingEinde" /></td>
        <td><CodeInline @code="xsd:dateTime" /></td>
      ...
      <tr>
        ...
        <td><CodeInline @code="mandaat:isTijdspecialisatieVan" /></td>
        <td><CodeInline @code="besluit:Bestuursorgaan" /></td>
  ...
  <AuTable>
    ...
    <:body>
      <tr>
        <td>naam</td>
        <td><CodeInline @code="regorg:legalName" /></td>
        <td><CodeInline @code="string" /></td>
        <td>De naam van de fractie</td>
      </tr>
      <tr>
        <td>bestuursorganen in tijd</td>
        <td><CodeInline @code="org:memberOf" /></td>
        <td><CodeInline @code="besluit:Bestuursorgaan" /></td>
        <td>De Bestuursorganen in de tijd waar de fractie deel van uitmaakt.</td>
      </tr>
      <tr>
        <td>fractietype</td>
        <td><CodeInline @code="ext:isFractietype" /></td>
        <td><CodeInline @code="skos:Concept" /></td>
        <td>het type van de fractie, hetzij samenstellingsverband
          <CodeInline
            @code="http://data.vlaanderen.be/id/concept/Fractietype/Samenwerkingsverband"
          />, hetzij onafhankelijk
          <CodeInline
            @code="http://data.vlaanderen.be/id/concept/Fractietype/Onafhankelijk"
          />.</td>
      </tr>
    </:body>
  </AuTable>
  ...
  <AuTable>
    ...
    <:body>
      <tr>
        ...
        <td><CodeInline @code="org:organisation" /></td>
        <td><CodeInline @code="mandaat:Fractie" /></td>
        <td>De fractie waar de mandataris lid van is</td>
      </tr>
      <tr>
        <td>lid gedurende</td>
        <td><CodeInline @code="org:memberDuring" /></td>
        <td><CodeInline @code="m8g:PeriodOfTime" /></td>
        <td>De periode waarin de mandataris lid is van de fractie. Deze periode
          zal altijd overeenkomen met de
          <CodeInline @code="mandaat:start" />
          en
          <CodeInline @code="mandaat:einde" />
  ...
  <AuHeading @level="4" @skin="4">Klasse</AuHeading>
  <p>
    <CodeInline @code="mandaat:Mandaat" />
  </p>
  <AuHeading @level="4" @skin="4">Beschrijving</AuHeading>
  <p>
    ...
    <CodeInline @code="mandaat:Mandataris" />.
  </p>
  <AuHeading @level="4" @skin="4">Eigenschappen</AuHeading>
  <AuTable>
    <:header>
    ...
    <:body>
      ...
      <tr>
        ...
        <td><CodeInline @code="mandaat:aantalHouders" /></td>
        <td><CodeInline @code="xsd:integer" /></td>
  ...
  <p>Een Mandataris is een geversioneerde entiteit. Dat betekent dat wanneer er
    ...
    doorheen de tijd, zonder dat er informatie verloren gaat.</p>
  <p>Er moet een nieuwe Mandataris aangemaakt worden wanneer:
    <ul>
  ...
  <p>Het is mogelijk dat er incorrecte gegevens werden ingegeven voor een
    ...
    nieuwe, correcte startdatum.</p>
  <p>Sommige organen hebben naast leden ook een voorzitter. Bij de gemeenteraad en
  ...
  <AuTable>
    ...
    <:body>
      ...
      <tr>
        <td>status</td>
        <td><CodeInline @code="mandaat:status" /></td>
        <td><CodeInline @code="skos:Concept" /></td>
        <td>De bestuurlijke status van de Mandataris. Dit kan gaan om Effectief (<CodeInline
            @code="http://data.vlaanderen.be/id/concept/MandatarisStatusCode/21063a5b-912c-4241-841c-cc7fb3c73e75"
          />), Verhinderd (<CodeInline
            @code="http://data.vlaanderen.be/id/concept/MandatarisStatusCode/c301248f-0199-45ca-b3e5-4c596731d5fe"
          />), Waarnemend (<CodeInline
            @code="http://data.vlaanderen.be/id/concept/MandatarisStatusCode/e1ca6edd-55e1-4288-92a5-53f4cf71946a"
          />), of Titelvoerend (<CodeInline
            @code="http://data.vlaanderen.be/id/concept/MandatarisStatusCode/aacb3fed-b51d-4e0b-a411-f3fa641da1b3"
          />).</td>
      </tr>
      <tr>
        <td>rangorde</td>
        <td><CodeInline @code="mandaat:rangorde" /></td>
        <td><CodeInline @code="xsd:string" /></td>
      ...
      <tr>
        <td>beleidsdomein</td>
        <td><CodeInline @code="mandaat:beleidsdomein" /></td>
        <td><CodeInline @code="skos:Concept" /></td>
      ...
      <tr>
        <td>lidmaatschap</td>
        <td><CodeInline @code="org:hasMembership" /></td>
        <td><CodeInline @code="besluit:Bestuursorgaan" /></td>
      ...
      <tr>
        ...
        <td><CodeInline @code="lmb:hasPublicationStatus" /></td>
        <td><CodeInline @code="skos:Concept" /></td>
        <td>De publicatie status van de Mandataris. Dit kan gaan om Draft (<CodeInline
            @code="http://data.lblod.info/id/concept/MandatarisPublicationStatusCode/588ce330-4abb-4448-9776-a17d9305df07"
          />), Niet Bekrachtigd (<CodeInline
            @code="http://data.lblod.info/id/concept/MandatarisPublicationStatusCode/d3b12468-3720-4cb0-95b4-6aa2996ab188"
          />), of Bekrachtigd (<CodeInline
            @code="http://data.lblod.info/id/concept/MandatarisPublicationStatusCode/9d8fd14d-95d0-4f5e-b3a5-a56a126227b6"
          />).</td>
      </tr>
      <tr>
        <td>is bestuurlijke alias van</td>
  ...
  */
  {
    "id": "RnEB0+J8",
    "block": "[[[8,[39,0],null,[[\"@level\",\"@skin\"],[\"1\",\"1\"]],[[\"default\"],[[[[1,\"Mandatendatabank\"]],[]]]]],[1,\"\\n\"],[10,2],[12],[1,\"\\n  Het lokaal mandatenbeheer en de mandatendatabank bevat de mandatarissen van de\\n  lokale besturen (gemeenten, OCMWs, districten en provincies). Deze databank\\n  volgt een uitbreiding op het applicatieprofiel\\n  \"],[8,[39,1],[[24,6,\"https://data.vlaanderen.be/doc/applicatieprofiel/mandatendatabank/\"]],null,[[\"default\"],[[[[1,\"mandatendatabank\"]],[]]]]],[1,\".\\n\"],[13],[1,\"\\n\"],[10,2],[12],[1,\"\\n  Dit document beschrijft deze uitbreiding.\\n  \"],[8,[39,1],[[24,6,\"https://drive.google.com/file/d/1fGkae_PGUZVHehHA33ratebByMtEu2W0/view?usp=drive_link\"]],null,[[\"default\"],[[[[1,\"Een class-diagram\"]],[]]]]],[1,\"\\n  dat deze uitbreiding weergeeft is ook beschikbaar. De stabiliteit van\\n  predicaten en types verschilt naar gelang de prefix. De\\n  \"],[8,[39,2],null,[[\"@code\"],[\"ext\"]],null],[1,\"\\n  prefix wordt gebruikt voor interne uitbreidingen en is het minst stabiel. De\\n  \"],[8,[39,2],null,[[\"@code\"],[\"lmb\"]],null],[1,\"\\n  prefix wordt gebruikt voor stabielere uitbreidingen die ook hergebruikt kunnen\\n  worden in het bredere LBLOD eco-systeem.\\n\"],[13],[1,\"\\n\"],[10,2],[12],[1,\"\\n  Opgelet! Sommige predicaten volgen de originele versie van het\\n  applicatieprofiel. Voorlopig wordt dit zo gehouden omdat de verschillende\\n  vendors dit model ook volgen. Bij publicatie worden beide versies van de uri\\n  aangeboden. Dit is het geval voor:\\n  \"],[10,\"ul\"],[12],[1,\"\\n    \"],[10,\"li\"],[12],[1,\"mandaat:isTijdspecialisatieVan: dit is officieel\\n      generiek:isTijdspecialisatieVan\"],[13],[1,\"\\n    \"],[10,\"li\"],[12],[1,\"generiek: deze prefix wordt met http gebruikt in de applicatie, maar in\\n      werkelijkheid is het een https prefix\"],[13],[1,\"\\n    \"],[10,\"li\"],[12],[1,\"besluit:classificatie: dit is officieel org:classification\"],[13],[1,\"\\n  \"],[13],[1,\"\\n\"],[13],[1,\"\\n\"],[10,2],[12],[1,\"\\n  Het lokaal mandatenbeheer heeft ook een\\n  \"],[8,[39,1],[[24,6,\"https://abb-vlaanderen.gitbook.io/handleiding-lokaal-mandatenbeheer\"]],null,[[\"default\"],[[[[1,\"gebruikershandleiding\"]],[]]]]],[1,\". Deze kan extra verheldering brengen\\n  over hoe de concepten in dit document in de praktijk gebruikt worden.\\n\"],[13],[1,\"\\n\"],[8,[39,0],null,[[\"@level\",\"@skin\"],[\"2\",\"2\"]],[[\"default\"],[[[[1,\"LDES feeds\"]],[]]]]],[1,\"\\n\"],[10,2],[12],[1,\"Het lokaal mandatenbeheer biedt verschillende LDES streams aan. Meer\\n  informatie over deze streams is terug te vinden in\\n  \"],[10,3],[14,6,\"https://github.com/lblod/app-lokaal-mandatenbeheer/blob/master/docs/LDES.md\"],[14,\"target\",\"_blank\"],[14,\"rel\",\"noopener noreferrer\"],[12],[1,\"de source code documentatie.\"],[13],[13],[1,\"\\n\\n\"],[8,[39,0],null,[[\"@level\",\"@skin\"],[\"2\",\"2\"]],[[\"default\"],[[[[1,\"Secure SPARQL endpoint\"]],[]]]]],[1,\"\\n\"],[10,2],[12],[1,\"Het lokaal mandatenbeheer biedt een secure sparql endpoint aan op de url\\n  \"],[10,3],[14,6,\"https://mandatenbeheer.lokaalbestuur.vlaanderen.be/vendor/sparql\"],[14,\"rel\",\"noopener noreferrer\"],[14,\"target\",\"_blank\"],[12],[1,\"https://mandatenbeheer.lokaalbestuur.vlaanderen.be/vendor/sparql\"],[13],[1,\". Dit\\n  endpoint is beveiligd via de\\n  \"],[10,3],[14,6,\"https://github.com/lblod/vendor-login-service\"],[14,\"target\",\"_blank\"],[14,\"rel\",\"noopener noreferrer\"],[12],[1,\"vendor login service\"],[13],[1,\"\\n  met dezelfde credentials als de credentials gebruikt in Loket. De procedure om\\n  deze aan te vragen staat beschreven in de documentatie van Loket.\"],[13],[1,\"\\n\\n\"],[8,[39,0],null,[[\"@level\",\"@skin\"],[\"2\",\"2\"]],[[\"default\"],[[[[1,\"Automatische doorstroom van informatie\"]],[]]]]],[1,\"\\n\"],[10,2],[12],[1,\"De informatie beheerd in lokaal mandatenbeheer stroomt automatisch voort naar\\n  Loket en van daar naar de Mandatendatabank en de centrale vindplaats.\\n  Mandatarissen in de draft status stromen niet automatisch door.\"],[13],[1,\"\\n\"],[10,2],[12],[1,\"Gevoelige persoonsgegevens als rijksregisternummers, geslachten en\\n  geboortedatums stromen ook niet door.\"],[13],[1,\"\\n\\n\"],[8,[39,0],null,[[\"@level\",\"@skin\"],[\"2\",\"2\"]],[[\"default\"],[[[[1,\"Gebruikte prefixen\"]],[]]]]],[1,\"\\n\"],[8,[39,3],null,null,[[\"header\",\"body\"],[[[[1,\"\\n    \"],[10,\"tr\"],[12],[1,\"\\n      \"],[10,\"th\"],[12],[1,\"Prefix\"],[13],[1,\"\\n      \"],[10,\"th\"],[12],[1,\"URI\"],[13],[1,\"\\n    \"],[13],[1,\"\\n  \"]],[]],[[[1,\"\\n    \"],[10,\"tr\"],[12],[1,\"\\n      \"],[10,\"td\"],[12],[8,[39,2],null,[[\"@code\"],[\"adres\"]],null],[13],[1,\"\\n      \"],[10,\"td\"],[12],[8,[39,1],[[24,6,\"https://data.vlaanderen.be/ns/adres#\"]],null,[[\"default\"],[[[[1,\"https://data.vlaanderen.be/ns/adres#\"]],[]]]]],[13],[1,\"\\n    \"],[13],[1,\"\\n    \"],[10,\"tr\"],[12],[1,\"\\n      \"],[10,\"td\"],[12],[8,[39,2],null,[[\"@code\"],[\"besluit\"]],null],[13],[1,\"\\n      \"],[10,\"td\"],[12],[8,[39,1],[[24,6,\"http://data.vlaanderen.be/ns/besluit#\"]],null,[[\"default\"],[[[[1,\"http://data.vlaanderen.be/ns/besluit#\"]],[]]]]],[13],[1,\"\\n    \"],[13],[1,\"\\n    \"],[10,\"tr\"],[12],[1,\"\\n      \"],[10,\"td\"],[12],[8,[39,2],null,[[\"@code\"],[\"ext\"]],null],[13],[1,\"\\n      \"],[10,\"td\"],[12],[8,[39,1],[[24,6,\"http://mu.semte.ch/vocabularies/ext/\"]],null,[[\"default\"],[[[[1,\"http://mu.semte.ch/vocabularies/ext/\"]],[]]]]],[13],[1,\"\\n    \"],[13],[1,\"\\n    \"],[10,\"tr\"],[12],[1,\"\\n      \"],[10,\"td\"],[12],[8,[39,2],null,[[\"@code\"],[\"foaf\"]],null],[13],[1,\"\\n      \"],[10,\"td\"],[12],[8,[39,1],[[24,6,\"http://xmlns.com/foaf/0.1/\"]],null,[[\"default\"],[[[[1,\"http://xmlns.com/foaf/0.1/\"]],[]]]]],[13],[1,\"\\n    \"],[13],[1,\"\\n    \"],[10,\"tr\"],[12],[1,\"\\n      \"],[10,\"td\"],[12],[8,[39,2],null,[[\"@code\"],[\"lblodlg\"]],null],[13],[1,\"\\n      \"],[10,\"td\"],[12],[8,[39,1],[[24,6,\"http://data.lblod.info/vocabularies/leidinggevenden/\"]],null,[[\"default\"],[[[[1,\"http://data.lblod.info/vocabularies/leidinggevenden/\"]],[]]]]],[13],[1,\"\\n    \"],[13],[1,\"\\n    \"],[10,\"tr\"],[12],[1,\"\\n      \"],[10,\"td\"],[12],[8,[39,2],null,[[\"@code\"],[\"locn\"]],null],[13],[1,\"\\n      \"],[10,\"td\"],[12],[8,[39,1],[[24,6,\"http://www.w3.org/ns/locn#\"]],null,[[\"default\"],[[[[1,\"http://www.w3.org/ns/locn#\"]],[]]]]],[13],[1,\"\\n    \"],[13],[1,\"\\n    \"],[10,\"tr\"],[12],[1,\"\\n      \"],[10,\"td\"],[12],[8,[39,2],null,[[\"@code\"],[\"lmb\"]],null],[13],[1,\"\\n      \"],[10,\"td\"],[12],[8,[39,1],[[24,6,\"http://lblod.data.gift/vocabularies/lmb/\"]],null,[[\"default\"],[[[[1,\"http://lblod.data.gift/vocabularies/lmb/\"]],[]]]]],[13],[1,\"\\n    \"],[13],[1,\"\\n    \"],[10,\"tr\"],[12],[1,\"\\n      \"],[10,\"td\"],[12],[8,[39,2],null,[[\"@code\"],[\"mandaat\"]],null],[13],[1,\"\\n      \"],[10,\"td\"],[12],[8,[39,1],[[24,6,\"http://data.vlaanderen.be/ns/mandaat#\"]],null,[[\"default\"],[[[[1,\"http://data.vlaanderen.be/ns/mandaat#\"]],[]]]]],[13],[1,\"\\n    \"],[13],[1,\"\\n    \"],[10,\"tr\"],[12],[1,\"\\n      \"],[10,\"td\"],[12],[8,[39,2],null,[[\"@code\"],[\"person\"]],null],[13],[1,\"\\n      \"],[10,\"td\"],[12],[8,[39,1],[[24,6,\"https://data.vlaanderen.be/ns/persoon#\"]],null,[[\"default\"],[[[[1,\"https://data.vlaanderen.be/ns/persoon#\"]],[]]]]],[13],[1,\"\\n    \"],[13],[1,\"\\n    \"],[10,\"tr\"],[12],[1,\"\\n      \"],[10,\"td\"],[12],[8,[39,2],null,[[\"@code\"],[\"persoon\"]],null],[13],[1,\"\\n      \"],[10,\"td\"],[12],[8,[39,1],[[24,6,\"http://www.w3.org/ns/person#\"]],null,[[\"default\"],[[[[1,\"http://www.w3.org/ns/person#\"]],[]]]]],[13],[1,\"\\n    \"],[13],[1,\"\\n    \"],[10,\"tr\"],[12],[1,\"\\n      \"],[10,\"td\"],[12],[8,[39,2],null,[[\"@code\"],[\"org\"]],null],[13],[1,\"\\n      \"],[10,\"td\"],[12],[8,[39,1],[[24,6,\"http://www.w3.org/ns/org#\"]],null,[[\"default\"],[[[[1,\"http://www.w3.org/ns/org#\"]],[]]]]],[13],[1,\"\\n    \"],[13],[1,\"\\n    \"],[10,\"tr\"],[12],[1,\"\\n      \"],[10,\"td\"],[12],[8,[39,2],null,[[\"@code\"],[\"schema\"]],null],[13],[1,\"\\n      \"],[10,\"td\"],[12],[8,[39,1],[[24,6,\"http://schema.org/\"]],null,[[\"default\"],[[[[1,\"http://schema.org/\"]],[]]]]],[13],[1,\"\\n    \"],[13],[1,\"\\n    \"],[10,\"tr\"],[12],[1,\"\\n      \"],[10,\"td\"],[12],[8,[39,2],null,[[\"@code\"],[\"xsd\"]],null],[13],[1,\"\\n      \"],[10,\"td\"],[12],[8,[39,1],[[24,6,\"http://www.w3.org/2001/XMLSchema#\"]],null,[[\"default\"],[[[[1,\"http://www.w3.org/2001/XMLSchema#\"]],[]]]]],[13],[1,\"\\n    \"],[13],[1,\"\\n  \"]],[]]]]],[1,\"\\n\\n\"],[8,[39,0],null,[[\"@level\",\"@skin\"],[\"2\",\"2\"]],[[\"default\"],[[[[1,\"Entiteiten\"]],[]]]]],[1,\"\\n\\n\"],[8,[39,0],null,[[\"@level\",\"@skin\"],[\"3\",\"3\"]],[[\"default\"],[[[[1,\"Besluit\"]],[]]]]],[1,\"\\n\"],[8,[39,0],null,[[\"@level\",\"@skin\"],[\"4\",\"4\"]],[[\"default\"],[[[[1,\"Klasse\"]],[]]]]],[1,\"\\n\"],[10,2],[12],[1,\"\\n  \"],[8,[39,2],null,[[\"@code\"],[\"besluit:Besluit\"]],null],[1,\"\\n\"],[13],[1,\"\\n\"],[8,[39,0],null,[[\"@level\",\"@skin\"],[\"4\",\"4\"]],[[\"default\"],[[[[1,\"Beschrijving\"]],[]]]]],[1,\"\\n\"],[10,2],[12],[1,\"\\n  Een besluit zoals gedefinieerd in het\\n  \"],[10,3],[14,6,\"https://data.vlaanderen.be/doc/applicatieprofiel/besluit-publicatie/#Besluit\"],[14,\"rel\",\"noopener noreferrer\"],[14,\"target\",\"_blank\"],[12],[1,\"besluit-publicatie.\"],[13],[1,\". In de implementatie is dit concept samengevoegd met\\n  \"],[8,[39,2],null,[[\"@code\"],[\"besluit:Rechtsgrond\"]],null],[1,\". Enkel de eigenschappen die\\n  relevant zijn voor de Mandatendatabank worden hieronder beschreven.\\n\"],[13],[1,\"\\n\"],[8,[39,0],null,[[\"@level\",\"@skin\"],[\"4\",\"4\"]],[[\"default\"],[[[[1,\"Eigenschappen\"]],[]]]]],[1,\"\\n\"],[8,[39,3],null,null,[[\"header\",\"body\"],[[[[1,\"\\n    \"],[10,\"tr\"],[12],[1,\"\\n      \"],[10,\"th\"],[12],[1,\"Naam\"],[13],[1,\"\\n      \"],[10,\"th\"],[12],[1,\"URI\"],[13],[1,\"\\n      \"],[10,\"th\"],[12],[1,\"Verwacht type\"],[13],[1,\"\\n      \"],[10,\"th\"],[12],[1,\"Beschrijving\"],[13],[1,\"\\n    \"],[13],[1,\"\\n  \"]],[]],[[[1,\"\\n    \"],[10,\"tr\"],[12],[1,\"\\n      \"],[10,\"td\"],[12],[1,\"bekrachtigt aanstelling van\"],[13],[1,\"\\n      \"],[10,\"td\"],[12],[8,[39,2],null,[[\"@code\"],[\"mandaat:bekrachtigtAanstellingVan\"]],null],[13],[1,\"\\n      \"],[10,\"td\"],[12],[8,[39,2],null,[[\"@code\"],[\"mandaat:Mandataris\"]],null],[13],[1,\"\\n      \"],[10,\"td\"],[12],[1,\"De Mandataris waarvan de aanstelling bekrachtigd wordt door dit\\n        besluit. Een bekrachtigde mandataris kan een link hebben naar een\\n        Besluit als dat besluit (voldoende) beschreven is in gelinkte data.\\n        Mandatarissen kunnen echter ook manueel bekrachtigd worden.\"],[13],[1,\"\\n    \"],[13],[1,\"\\n    \"],[10,\"tr\"],[12],[1,\"\\n      \"],[10,\"td\"],[12],[1,\"bekrachtigt ontslag van\"],[13],[1,\"\\n      \"],[10,\"td\"],[12],[8,[39,2],null,[[\"@code\"],[\"mandaat:bekrachtigtOntslagVan\"]],null],[13],[1,\"\\n      \"],[10,\"td\"],[12],[8,[39,2],null,[[\"@code\"],[\"mandaat:Mandataris\"]],null],[13],[1,\"\\n      \"],[10,\"td\"],[12],[1,\"De Mandataris waarvan het mandaat door dit besluit beëindigd wordt.\"],[13],[1,\"\\n    \"],[13],[1,\"\\n  \"]],[]]]]],[1,\"\\n\"],[8,[39,0],null,[[\"@level\",\"@skin\"],[\"4\",\"4\"]],[[\"default\"],[[[[1,\"Voorbeeld\"]],[]]]]],[1,\"\\n\"],[8,[39,4],null,[[\"@snippetFilename\"],[\"mandaten-annotaties/besluit.turtle\"]],null],[1,\"\\n\\n\"],[8,[39,0],null,[[\"@level\",\"@skin\"],[\"3\",\"3\"]],[[\"default\"],[[[[1,\"Bestuursorgaan (in bestuursperiode)\"]],[]]]]],[1,\"\\n\"],[8,[39,0],null,[[\"@level\",\"@skin\"],[\"4\",\"4\"]],[[\"default\"],[[[[1,\"Klasse\"]],[]]]]],[1,\"\\n\"],[10,2],[12],[1,\"\\n  \"],[8,[39,2],null,[[\"@code\"],[\"besluit:Bestuursorgaan\"]],null],[1,\"\\n\"],[13],[1,\"\\n\"],[8,[39,0],null,[[\"@level\",\"@skin\"],[\"4\",\"4\"]],[[\"default\"],[[[[1,\"Beschrijving\"]],[]]]]],[1,\"\\n\"],[10,2],[12],[1,\"\\n  Een bestuursorgaan, eventueel beperkt tot een bepaalde bestuursperiode.\\n  Dezelfde klasse wordt gebruikt om een Bestuursorgaan weer te geven als om een\\n  Bestuursorgaan in de tijd weer te geven. Het onderscheid tussen beide wordt\\n  gemaakt door de eigenschap\\n  \"],[8,[39,2],null,[[\"@code\"],[\"besluit:isTijdspecialisatieVan\"]],null],[1,\"\\n  waarmee een Bestuursorgaan in de tijd verwijst naar zijn bestuursorgaan.\\n  Daarnaast wordt de\\n  \"],[8,[39,2],null,[[\"@code\"],[\"besluit:classificatie\"]],null],[1,\"\\n  enkel gespecificeerd op een Bestuursorgaan, niet op een Bestuursorgaan in de\\n  tijd. Een Bestuursorgaan in de tijd heeft een\\n  \"],[8,[39,2],null,[[\"@code\"],[\"mandaat:bindingStart\"]],null],[1,\"\\n  en een\\n  \"],[8,[39,2],null,[[\"@code\"],[\"mandaat:bindingEinde\"]],null],[1,\". Deze eigenschappen geven aan\\n  wanneer het Bestuursorgaan in de tijd actief is. Indien een Bestuursorgaan in\\n  de tijd geen\\n  \"],[8,[39,2],null,[[\"@code\"],[\"mandaat:bindingEinde\"]],null],[1,\"\\n  heeft, is het Bestuursorgaan in de tijd nog steeds actief. Enkel\\n  Bestuursorganen in de tijd zijn gekoppeld aan instanties van de klasse\\n  \"],[8,[39,2],null,[[\"@code\"],[\"mandaat:Mandaat\"]],null],[1,\". Dat betekent dus ook dat de URI van\\n  bijvoorbeeld een burgemeester mandaat verandert per bestuursperiode. De\\n  classificatie code (\"],[8,[39,2],null,[[\"@code\"],[\"org:role\"]],null],[1,\") blijft wel dezelfde\\n  uiteraard.\\n\"],[13],[1,\"\\n\"],[8,[39,0],null,[[\"@level\",\"@skin\"],[\"4\",\"4\"]],[[\"default\"],[[[[1,\"Eigenschappen\"]],[]]]]],[1,\"\\n\"],[8,[39,3],null,null,[[\"header\",\"body\"],[[[[1,\"\\n    \"],[10,\"tr\"],[12],[1,\"\\n      \"],[10,\"th\"],[12],[1,\"Naam\"],[13],[1,\"\\n      \"],[10,\"th\"],[12],[1,\"URI\"],[13],[1,\"\\n      \"],[10,\"th\"],[12],[1,\"Verwacht type\"],[13],[1,\"\\n      \"],[10,\"th\"],[12],[1,\"Beschrijving\"],[13],[1,\"\\n    \"],[13],[1,\"\\n  \"]],[]],[[[1,\"\\n    \"],[10,\"tr\"],[12],[1,\"\\n      \"],[10,\"td\"],[12],[1,\"bevat\"],[13],[1,\"\\n      \"],[10,\"td\"],[12],[8,[39,2],null,[[\"@code\"],[\"org:hasPost\"]],null],[13],[1,\"\\n      \"],[10,\"td\"],[12],[8,[39,2],null,[[\"@code\"],[\"mandaat:Mandaat\"]],null],[13],[1,\"\\n      \"],[10,\"td\"],[12],[1,\"Een mandaat dat binnen dit bestuursorgaan in de tijd bekleed kan\\n        worden. Een mandaat kan op deze manier deel zijn van verschillende\\n        Bestuursorganen in de tijd. Zo is het Burgemeester mandaat steeds deel\\n        van het Bestuursorgaan Burgemeester en het Bestuursorgaan College van\\n        Burgemeester en Schepenen.\"],[13],[1,\"\\n    \"],[13],[1,\"\\n    \"],[10,\"tr\"],[12],[1,\"\\n      \"],[10,\"td\"],[12],[1,\"bindingStart\"],[13],[1,\"\\n      \"],[10,\"td\"],[12],[8,[39,2],null,[[\"@code\"],[\"mandaat:bindingStart\"]],null],[13],[1,\"\\n      \"],[10,\"td\"],[12],[8,[39,2],null,[[\"@code\"],[\"xsd:dateTime\"]],null],[13],[1,\"\\n      \"],[10,\"td\"],[12],[1,\"Het tijdstip waar op dit Bestuursorgaan in de tijd actief wordt/werd.\"],[13],[1,\"\\n    \"],[13],[1,\"\\n    \"],[10,\"tr\"],[12],[1,\"\\n      \"],[10,\"td\"],[12],[1,\"bindingEinde\"],[13],[1,\"\\n      \"],[10,\"td\"],[12],[8,[39,2],null,[[\"@code\"],[\"mandaat:bindingEinde\"]],null],[13],[1,\"\\n      \"],[10,\"td\"],[12],[8,[39,2],null,[[\"@code\"],[\"xsd:dateTime\"]],null],[13],[1,\"\\n      \"],[10,\"td\"],[12],[1,\"Het tijdstip waar op dit Bestuursorgaan in de tijd niet langer actief\\n        wordt/werd.\"],[13],[1,\"\\n    \"],[13],[1,\"\\n    \"],[10,\"tr\"],[12],[1,\"\\n      \"],[10,\"td\"],[12],[1,\"classificatie\"],[13],[1,\"\\n      \"],[10,\"td\"],[12],[8,[39,2],null,[[\"@code\"],[\"besluit:classificatie\"]],null],[13],[1,\"\\n      \"],[10,\"td\"],[12],[8,[39,2],null,[[\"@code\"],[\"skos:Concept\"]],null],[13],[1,\"\\n      \"],[10,\"td\"],[12],[1,\"De classificatie van het bestuursorgaan. Bijvoorbeeld Gemeenteraad, of\\n        Burgemeester.\"],[13],[1,\"\\n    \"],[13],[1,\"\\n    \"],[10,\"tr\"],[12],[1,\"\\n      \"],[10,\"td\"],[12],[1,\"isTijdspecialisatieVan\"],[13],[1,\"\\n      \"],[10,\"td\"],[12],[8,[39,2],null,[[\"@code\"],[\"mandaat:isTijdspecialisatieVan\"]],null],[13],[1,\"\\n      \"],[10,\"td\"],[12],[8,[39,2],null,[[\"@code\"],[\"besluit:Bestuursorgaan\"]],null],[13],[1,\"\\n      \"],[10,\"td\"],[12],[1,\"Het bestuursorgaan waarvan dit Bestuursorgaan in de tijd een\\n        specialisatie is.\"],[13],[1,\"\\n    \"],[13],[1,\"\\n  \"]],[]]]]],[1,\"\\n\"],[8,[39,0],null,[[\"@level\",\"@skin\"],[\"4\",\"4\"]],[[\"default\"],[[[[1,\"Voorbeeld\"]],[]]]]],[1,\"\\n\"],[8,[39,4],null,[[\"@snippetFilename\"],[\"mandaten-annotaties/bestuursorgaan.turtle\"]],null],[1,\"\\n\\n\"],[8,[39,0],null,[[\"@level\",\"@skin\"],[\"3\",\"3\"]],[[\"default\"],[[[[1,\"Fractie\"]],[]]]]],[1,\"\\n\"],[8,[39,0],null,[[\"@level\",\"@skin\"],[\"4\",\"4\"]],[[\"default\"],[[[[1,\"Klasse\"]],[]]]]],[1,\"\\n\"],[10,2],[12],[1,\"\\n  \"],[8,[39,2],null,[[\"@code\"],[\"mandaat:Fractie\"]],null],[1,\"\\n\"],[13],[1,\"\\n\"],[8,[39,0],null,[[\"@level\",\"@skin\"],[\"4\",\"4\"]],[[\"default\"],[[[[1,\"Beschrijving\"]],[]]]]],[1,\"\\n\"],[10,2],[12],[1,\"\\n  Een politieke fractie binnen een bestuursorgaan. Mandatarissen zijn gelinkt\\n  aan een fractie via een instantie van de\\n  \"],[8,[39,2],null,[[\"@code\"],[\"org:Membership\"]],null],[1,\"\\n  klasse. Binnen één legislatuur kan een persoon enkel lid zijn van 1 politieke\\n  fractie en eventueel 1 'onafhankelijke' fractie. Dergelijke onafhankelijke\\n  fracties hebben telkens maar 1 persoon die er lid van is (eventueel via\\n  meerdere Mandatarissen als de persoon meerdere mandaten heeft of er\\n  statusveranderingen zijn in de opname van het mandaat, zoals een verandering\\n  in rangorde).\\n\"],[13],[1,\"\\n\"],[8,[39,0],null,[[\"@level\",\"@skin\"],[\"4\",\"4\"]],[[\"default\"],[[[[1,\"Eigenschappen\"]],[]]]]],[1,\"\\n\"],[8,[39,3],null,null,[[\"header\",\"body\"],[[[[1,\"\\n    \"],[10,\"tr\"],[12],[1,\"\\n      \"],[10,\"th\"],[12],[1,\"Naam\"],[13],[1,\"\\n      \"],[10,\"th\"],[12],[1,\"URI\"],[13],[1,\"\\n      \"],[10,\"th\"],[12],[1,\"Verwacht type\"],[13],[1,\"\\n      \"],[10,\"th\"],[12],[1,\"Beschrijving\"],[13],[1,\"\\n    \"],[13],[1,\"\\n  \"]],[]],[[[1,\"\\n    \"],[10,\"tr\"],[12],[1,\"\\n      \"],[10,\"td\"],[12],[1,\"naam\"],[13],[1,\"\\n      \"],[10,\"td\"],[12],[8,[39,2],null,[[\"@code\"],[\"regorg:legalName\"]],null],[13],[1,\"\\n      \"],[10,\"td\"],[12],[8,[39,2],null,[[\"@code\"],[\"string\"]],null],[13],[1,\"\\n      \"],[10,\"td\"],[12],[1,\"De naam van de fractie\"],[13],[1,\"\\n    \"],[13],[1,\"\\n    \"],[10,\"tr\"],[12],[1,\"\\n      \"],[10,\"td\"],[12],[1,\"bestuursorganen in tijd\"],[13],[1,\"\\n      \"],[10,\"td\"],[12],[8,[39,2],null,[[\"@code\"],[\"org:memberOf\"]],null],[13],[1,\"\\n      \"],[10,\"td\"],[12],[8,[39,2],null,[[\"@code\"],[\"besluit:Bestuursorgaan\"]],null],[13],[1,\"\\n      \"],[10,\"td\"],[12],[1,\"De Bestuursorganen in de tijd waar de fractie deel van uitmaakt.\"],[13],[1,\"\\n    \"],[13],[1,\"\\n    \"],[10,\"tr\"],[12],[1,\"\\n      \"],[10,\"td\"],[12],[1,\"fractietype\"],[13],[1,\"\\n      \"],[10,\"td\"],[12],[8,[39,2],null,[[\"@code\"],[\"ext:isFractietype\"]],null],[13],[1,\"\\n      \"],[10,\"td\"],[12],[8,[39,2],null,[[\"@code\"],[\"skos:Concept\"]],null],[13],[1,\"\\n      \"],[10,\"td\"],[12],[1,\"het type van de fractie, hetzij samenstellingsverband\\n        \"],[8,[39,2],null,[[\"@code\"],[\"http://data.vlaanderen.be/id/concept/Fractietype/Samenwerkingsverband\"]],null],[1,\", hetzij onafhankelijk\\n        \"],[8,[39,2],null,[[\"@code\"],[\"http://data.vlaanderen.be/id/concept/Fractietype/Onafhankelijk\"]],null],[1,\".\"],[13],[1,\"\\n    \"],[13],[1,\"\\n  \"]],[]]]]],[1,\"\\n\"],[8,[39,0],null,[[\"@level\",\"@skin\"],[\"4\",\"4\"]],[[\"default\"],[[[[1,\"Voorbeeld\"]],[]]]]],[1,\"\\n\"],[8,[39,4],null,[[\"@snippetFilename\"],[\"mandaten-annotaties/fractie.turtle\"]],null],[1,\"\\n\\n\"],[8,[39,0],null,[[\"@level\",\"@skin\"],[\"3\",\"3\"]],[[\"default\"],[[[[1,\"Lidmaatschap\"]],[]]]]],[1,\"\\n\"],[8,[39,0],null,[[\"@level\",\"@skin\"],[\"4\",\"4\"]],[[\"default\"],[[[[1,\"Klasse\"]],[]]]]],[1,\"\\n\"],[10,2],[12],[1,\"\\n  \"],[8,[39,2],null,[[\"@code\"],[\"org:Membership\"]],null],[1,\"\\n\"],[13],[1,\"\\n\"],[8,[39,0],null,[[\"@level\",\"@skin\"],[\"4\",\"4\"]],[[\"default\"],[[[[1,\"Beschrijving\"]],[]]]]],[1,\"\\n\"],[10,2],[12],[1,\"\\n  De voorstelling van het lidmaatschap van een mandataris aan een fractie. De\\n  start en het einde van het lidmaatschap komen steeds overeen met de start en\\n  de einddatum van de Mandataris aangezien er bij verandering van fractie een\\n  nieuwe Mandataris wordt aangemaakt.\\n\"],[13],[1,\"\\n\"],[8,[39,0],null,[[\"@level\",\"@skin\"],[\"4\",\"4\"]],[[\"default\"],[[[[1,\"Eigenschappen\"]],[]]]]],[1,\"\\n\"],[8,[39,3],null,null,[[\"header\",\"body\"],[[[[1,\"\\n    \"],[10,\"tr\"],[12],[1,\"\\n      \"],[10,\"th\"],[12],[1,\"Naam\"],[13],[1,\"\\n      \"],[10,\"th\"],[12],[1,\"URI\"],[13],[1,\"\\n      \"],[10,\"th\"],[12],[1,\"Verwacht type\"],[13],[1,\"\\n      \"],[10,\"th\"],[12],[1,\"Beschrijving\"],[13],[1,\"\\n    \"],[13],[1,\"\\n  \"]],[]],[[[1,\"\\n    \"],[10,\"tr\"],[12],[1,\"\\n      \"],[10,\"td\"],[12],[1,\"binnen fractie\"],[13],[1,\"\\n      \"],[10,\"td\"],[12],[8,[39,2],null,[[\"@code\"],[\"org:organisation\"]],null],[13],[1,\"\\n      \"],[10,\"td\"],[12],[8,[39,2],null,[[\"@code\"],[\"mandaat:Fractie\"]],null],[13],[1,\"\\n      \"],[10,\"td\"],[12],[1,\"De fractie waar de mandataris lid van is\"],[13],[1,\"\\n    \"],[13],[1,\"\\n    \"],[10,\"tr\"],[12],[1,\"\\n      \"],[10,\"td\"],[12],[1,\"lid gedurende\"],[13],[1,\"\\n      \"],[10,\"td\"],[12],[8,[39,2],null,[[\"@code\"],[\"org:memberDuring\"]],null],[13],[1,\"\\n      \"],[10,\"td\"],[12],[8,[39,2],null,[[\"@code\"],[\"m8g:PeriodOfTime\"]],null],[13],[1,\"\\n      \"],[10,\"td\"],[12],[1,\"De periode waarin de mandataris lid is van de fractie. Deze periode\\n        zal altijd overeenkomen met de\\n        \"],[8,[39,2],null,[[\"@code\"],[\"mandaat:start\"]],null],[1,\"\\n        en\\n        \"],[8,[39,2],null,[[\"@code\"],[\"mandaat:einde\"]],null],[1,\"\\n        van de Mandataris. In de applicatie Lokaal Mandatenbeheer zal het\\n        tijdsinterval dan ook niet opgeslagen worden, het wordt bij publicatie\\n        berekend.\"],[13],[1,\"\\n    \"],[13],[1,\"\\n  \"]],[]]]]],[1,\"\\n\"],[8,[39,0],null,[[\"@level\",\"@skin\"],[\"4\",\"4\"]],[[\"default\"],[[[[1,\"Voorbeeld\"]],[]]]]],[1,\"\\n\"],[8,[39,4],null,[[\"@snippetFilename\"],[\"mandaten-annotaties/lidmaatschap.turtle\"]],null],[1,\"\\n\\n\"],[8,[39,0],null,[[\"@level\",\"@skin\"],[\"3\",\"3\"]],[[\"default\"],[[[[1,\"Mandaat\"]],[]]]]],[1,\"\\n\"],[8,[39,0],null,[[\"@level\",\"@skin\"],[\"4\",\"4\"]],[[\"default\"],[[[[1,\"Klasse\"]],[]]]]],[1,\"\\n\"],[10,2],[12],[1,\"\\n  \"],[8,[39,2],null,[[\"@code\"],[\"mandaat:Mandaat\"]],null],[1,\"\\n\"],[13],[1,\"\\n\"],[8,[39,0],null,[[\"@level\",\"@skin\"],[\"4\",\"4\"]],[[\"default\"],[[[[1,\"Beschrijving\"]],[]]]]],[1,\"\\n\"],[10,2],[12],[1,\"\\n  Een mandaat dat bekleed kan worden binnen een Bestuursorgaan in de tijd. De\\n  opname van een mandaat wordt voorgesteld door een\\n  \"],[8,[39,2],null,[[\"@code\"],[\"mandaat:Mandataris\"]],null],[1,\".\\n\"],[13],[1,\"\\n\"],[8,[39,0],null,[[\"@level\",\"@skin\"],[\"4\",\"4\"]],[[\"default\"],[[[[1,\"Eigenschappen\"]],[]]]]],[1,\"\\n\"],[8,[39,3],null,null,[[\"header\",\"body\"],[[[[1,\"\\n    \"],[10,\"tr\"],[12],[1,\"\\n      \"],[10,\"th\"],[12],[1,\"Naam\"],[13],[1,\"\\n      \"],[10,\"th\"],[12],[1,\"URI\"],[13],[1,\"\\n      \"],[10,\"th\"],[12],[1,\"Verwacht type\"],[13],[1,\"\\n      \"],[10,\"th\"],[12],[1,\"Beschrijving\"],[13],[1,\"\\n    \"],[13],[1,\"\\n  \"]],[]],[[[1,\"\\n    \"],[10,\"tr\"],[12],[1,\"\\n      \"],[10,\"td\"],[12],[1,\"bestuursfunctie\"],[13],[1,\"\\n      \"],[10,\"td\"],[12],[8,[39,2],null,[[\"@code\"],[\"org:role\"]],null],[13],[1,\"\\n      \"],[10,\"td\"],[12],[8,[39,2],null,[[\"@code\"],[\"skos:Concept\"]],null],[13],[1,\"\\n      \"],[10,\"td\"],[12],[1,\"De bestuursfunctie code van het mandaat, bijvoorbeeld Gemeenteraadslid\\n        of Burgemeester.\"],[13],[1,\"\\n    \"],[13],[1,\"\\n    \"],[10,\"tr\"],[12],[1,\"\\n      \"],[10,\"td\"],[12],[1,\"aantal houders\"],[13],[1,\"\\n      \"],[10,\"td\"],[12],[8,[39,2],null,[[\"@code\"],[\"mandaat:aantalHouders\"]],null],[13],[1,\"\\n      \"],[10,\"td\"],[12],[8,[39,2],null,[[\"@code\"],[\"xsd:integer\"]],null],[13],[1,\"\\n      \"],[10,\"td\"],[12],[1,\"Het minimum aantal houders voor het mandaat.\"],[13],[1,\"\\n    \"],[13],[1,\"\\n  \"]],[]]]]],[1,\"\\n\"],[8,[39,0],null,[[\"@level\",\"@skin\"],[\"4\",\"4\"]],[[\"default\"],[[[[1,\"Voorbeeld\"]],[]]]]],[1,\"\\n\"],[8,[39,4],null,[[\"@snippetFilename\"],[\"mandaten-annotaties/mandaat.turtle\"]],null],[1,\"\\n\\n\"],[8,[39,0],null,[[\"@level\",\"@skin\"],[\"3\",\"3\"]],[[\"default\"],[[[[1,\"Mandataris\"]],[]]]]],[1,\"\\n\"],[8,[39,0],null,[[\"@level\",\"@skin\"],[\"4\",\"4\"]],[[\"default\"],[[[[1,\"Klasse\"]],[]]]]],[1,\"\\n\"],[10,2],[12],[1,\"\\n  \"],[8,[39,2],null,[[\"@code\"],[\"mandaat:Mandataris\"]],null],[1,\"\\n\"],[13],[1,\"\\n\"],[8,[39,0],null,[[\"@level\",\"@skin\"],[\"4\",\"4\"]],[[\"default\"],[[[[1,\"Beschrijving\"]],[]]]]],[1,\"\\n\"],[10,2],[12],[1,\"\\n  Een persoon in zijn rol als houder van een mandaat.\\n\"],[13],[1,\"\\n\"],[10,2],[12],[1,\"Een Mandataris is een geversioneerde entiteit. Dat betekent dat wanneer er\\n  zich veranderingen voordoen in de opname van een Mandaat door een Persoon, er\\n  een nieuwe instantie van Mandataris zal aangemaakt worden. De oude Mandataris\\n  krijgt een einddatum van het moment van de aanpassing, met als waarden de oude\\n  status van de Mandataris en er wordt een nieuwe Mandataris instantie gemaakt\\n  met als startdatum het moment van de verandering en de nieuwe waarden. Op deze\\n  manier wordt er een historiek gecreëerd van hoe de Mandataris verandert\\n  doorheen de tijd, zonder dat er informatie verloren gaat.\"],[13],[1,\"\\n\"],[10,2],[12],[1,\"Er moet een nieuwe Mandataris aangemaakt worden wanneer:\\n  \"],[10,\"ul\"],[12],[1,\"\\n    \"],[10,\"li\"],[12],[1,\"De mandataris van bestuurlijke status verandert (e.g. de mandataris\\n      raakt verhinderd)\"],[13],[1,\"\\n    \"],[10,\"li\"],[12],[1,\"De mandataris van fractie verandert (e.g. de mandataris wordt\\n      onafhankelijk)\"],[13],[1,\"\\n    \"],[10,\"li\"],[12],[1,\"De mandataris van rangorde verandert (e.g. de mandataris schuift een\\n      plaatsje op omdat een andere mandataris vervangen wordt)\"],[13],[1,\"\\n    \"],[10,\"li\"],[12],[1,\"De mandataris een ander mandaat opneemt (e.g. de aangewezen burgemeester\\n      wordt nu burgemeester)\"],[13],[1,\"\\n    \"],[10,\"li\"],[12],[1,\"Het mandaat opgenomen wordt door een andere persoon\"],[13],[1,\"\\n  \"],[13],[1,\"\\n\"],[13],[1,\"\\n\"],[10,2],[12],[1,\"Het is mogelijk dat er incorrecte gegevens werden ingegeven voor een\\n  Mandataris, bijvoorbeeld een verkeerde startdatum. In dat geval moet er geen\\n  nieuwe Mandataris aangemaakt worden, de gegevens waren immers foutief en\\n  moeten niet bijgehouden worden. De bestaande Mandataris krijgt dan gewoon een\\n  nieuwe, correcte startdatum.\"],[13],[1,\"\\n\"],[10,2],[12],[1,\"Sommige organen hebben naast leden ook een voorzitter. Bij de gemeenteraad en\\n  raad van maatschappelijk welzijn moet de voorzitter ook steeds lid zijn van\\n  het orgaan, hij of zij heeft dus telkens 2 mandaten met dezelfde start en\\n  einddatums.\"],[13],[1,\"\\n\"],[8,[39,0],null,[[\"@level\",\"@skin\"],[\"4\",\"4\"]],[[\"default\"],[[[[1,\"Eigenschappen\"]],[]]]]],[1,\"\\n\"],[8,[39,3],null,null,[[\"header\",\"body\"],[[[[1,\"\\n    \"],[10,\"tr\"],[12],[1,\"\\n      \"],[10,\"th\"],[12],[1,\"Naam\"],[13],[1,\"\\n      \"],[10,\"th\"],[12],[1,\"URI\"],[13],[1,\"\\n      \"],[10,\"th\"],[12],[1,\"Verwacht type\"],[13],[1,\"\\n      \"],[10,\"th\"],[12],[1,\"Beschrijving\"],[13],[1,\"\\n    \"],[13],[1,\"\\n  \"]],[]],[[[1,\"\\n    \"],[10,\"tr\"],[12],[1,\"\\n      \"],[10,\"td\"],[12],[1,\"bekleedt\"],[13],[1,\"\\n      \"],[10,\"td\"],[12],[8,[39,2],null,[[\"@code\"],[\"org:holds\"]],null],[13],[1,\"\\n      \"],[10,\"td\"],[12],[8,[39,2],null,[[\"@code\"],[\"mandaat:Mandaat\"]],null],[13],[1,\"\\n      \"],[10,\"td\"],[12],[1,\"Het mandaat dat deze mandataris bekleedt.\"],[13],[1,\"\\n    \"],[13],[1,\"\\n    \"],[10,\"tr\"],[12],[1,\"\\n      \"],[10,\"td\"],[12],[1,\"start\"],[13],[1,\"\\n      \"],[10,\"td\"],[12],[8,[39,2],null,[[\"@code\"],[\"mandaat:start\"]],null],[13],[1,\"\\n      \"],[10,\"td\"],[12],[8,[39,2],null,[[\"@code\"],[\"xsd:dateTime\"]],null],[13],[1,\"\\n      \"],[10,\"td\"],[12],[1,\"Tijdstip vanaf wanneer de mandataris het mandaat opneemt. Dit tijdstip\\n        wordt gezet op het begin van de dag, er is immers niet voldoende\\n        precisie bij het verzamelen/annoteren van de gegevens om tot op het\\n        uur/de minuut exact dit tijdstip te bepalen.\"],[13],[1,\"\\n    \"],[13],[1,\"\\n    \"],[10,\"tr\"],[12],[1,\"\\n      \"],[10,\"td\"],[12],[1,\"einde\"],[13],[1,\"\\n      \"],[10,\"td\"],[12],[8,[39,2],null,[[\"@code\"],[\"mandaat:einde\"]],null],[13],[1,\"\\n      \"],[10,\"td\"],[12],[8,[39,2],null,[[\"@code\"],[\"xsd:dateTime\"]],null],[13],[1,\"\\n      \"],[10,\"td\"],[12],[1,\"Tijdstip vanaf wanneer de mandataris de bestuursfunctie niet langer\\n        opneemt. Dit tijdstip wordt gezet op het einde van de dag (23:59:59), er\\n        is immers niet voldoende precisie bij het verzamelen/annoteren van de\\n        gegevens om tot op het uur/de minuut exact dit tijdstip te bepalen.\"],[13],[1,\"\\n    \"],[13],[1,\"\\n    \"],[10,\"tr\"],[12],[1,\"\\n      \"],[10,\"td\"],[12],[1,\"status\"],[13],[1,\"\\n      \"],[10,\"td\"],[12],[8,[39,2],null,[[\"@code\"],[\"mandaat:status\"]],null],[13],[1,\"\\n      \"],[10,\"td\"],[12],[8,[39,2],null,[[\"@code\"],[\"skos:Concept\"]],null],[13],[1,\"\\n      \"],[10,\"td\"],[12],[1,\"De bestuurlijke status van de Mandataris. Dit kan gaan om Effectief (\"],[8,[39,2],null,[[\"@code\"],[\"http://data.vlaanderen.be/id/concept/MandatarisStatusCode/21063a5b-912c-4241-841c-cc7fb3c73e75\"]],null],[1,\"), Verhinderd (\"],[8,[39,2],null,[[\"@code\"],[\"http://data.vlaanderen.be/id/concept/MandatarisStatusCode/c301248f-0199-45ca-b3e5-4c596731d5fe\"]],null],[1,\"), Waarnemend (\"],[8,[39,2],null,[[\"@code\"],[\"http://data.vlaanderen.be/id/concept/MandatarisStatusCode/e1ca6edd-55e1-4288-92a5-53f4cf71946a\"]],null],[1,\"), of Titelvoerend (\"],[8,[39,2],null,[[\"@code\"],[\"http://data.vlaanderen.be/id/concept/MandatarisStatusCode/aacb3fed-b51d-4e0b-a411-f3fa641da1b3\"]],null],[1,\").\"],[13],[1,\"\\n    \"],[13],[1,\"\\n    \"],[10,\"tr\"],[12],[1,\"\\n      \"],[10,\"td\"],[12],[1,\"rangorde\"],[13],[1,\"\\n      \"],[10,\"td\"],[12],[8,[39,2],null,[[\"@code\"],[\"mandaat:rangorde\"]],null],[13],[1,\"\\n      \"],[10,\"td\"],[12],[8,[39,2],null,[[\"@code\"],[\"xsd:string\"]],null],[13],[1,\"\\n      \"],[10,\"td\"],[12],[1,\"De rangorde van de mandataris als string. Voor gemeenteraadsleden is\\n        dit bijvoorbeeld 'eerste lid', voor schepenen 'zesde schepen'. Enkel\\n        voor gemeenteraadsleden en schepenen is er een rangorde verplicht.\\n      \"],[13],[1,\"\\n    \"],[13],[1,\"\\n    \"],[10,\"tr\"],[12],[1,\"\\n      \"],[10,\"td\"],[12],[1,\"beleidsdomein\"],[13],[1,\"\\n      \"],[10,\"td\"],[12],[8,[39,2],null,[[\"@code\"],[\"mandaat:beleidsdomein\"]],null],[13],[1,\"\\n      \"],[10,\"td\"],[12],[8,[39,2],null,[[\"@code\"],[\"skos:Concept\"]],null],[13],[1,\"\\n      \"],[10,\"td\"],[12],[1,\"De beleidsdomeinen van een mandataris. Een mandataris kan meerdere\\n        beleidsdomeinen hebben. Enkel burgemeesters en schepenen hebben\\n        beleidsdomeinen. Opgelet: lokale besturen kunnen zelf nieuwe concepten\\n        definiëren als beleidsdomein, dat betekent dat er bijvoorbeeld meerdere\\n        beleidsdomeinen kunnen zijn met dezelfde naam.\\n      \"],[13],[1,\"\\n    \"],[13],[1,\"\\n    \"],[10,\"tr\"],[12],[1,\"\\n      \"],[10,\"td\"],[12],[1,\"lidmaatschap\"],[13],[1,\"\\n      \"],[10,\"td\"],[12],[8,[39,2],null,[[\"@code\"],[\"org:hasMembership\"]],null],[13],[1,\"\\n      \"],[10,\"td\"],[12],[8,[39,2],null,[[\"@code\"],[\"besluit:Bestuursorgaan\"]],null],[13],[1,\"\\n      \"],[10,\"td\"],[12],[1,\"Het lidmaatschap van de mandataris. Er is altijd exact 1 lidmaatschap\\n        per mandataris.\"],[13],[1,\"\\n    \"],[13],[1,\"\\n    \"],[10,\"tr\"],[12],[1,\"\\n      \"],[10,\"td\"],[12],[1,\"publicatiestatus\"],[13],[1,\"\\n      \"],[10,\"td\"],[12],[8,[39,2],null,[[\"@code\"],[\"lmb:hasPublicationStatus\"]],null],[13],[1,\"\\n      \"],[10,\"td\"],[12],[8,[39,2],null,[[\"@code\"],[\"skos:Concept\"]],null],[13],[1,\"\\n      \"],[10,\"td\"],[12],[1,\"De publicatie status van de Mandataris. Dit kan gaan om Draft (\"],[8,[39,2],null,[[\"@code\"],[\"http://data.lblod.info/id/concept/MandatarisPublicationStatusCode/588ce330-4abb-4448-9776-a17d9305df07\"]],null],[1,\"), Niet Bekrachtigd (\"],[8,[39,2],null,[[\"@code\"],[\"http://data.lblod.info/id/concept/MandatarisPublicationStatusCode/d3b12468-3720-4cb0-95b4-6aa2996ab188\"]],null],[1,\"), of Bekrachtigd (\"],[8,[39,2],null,[[\"@code\"],[\"http://data.lblod.info/id/concept/MandatarisPublicationStatusCode/9d8fd14d-95d0-4f5e-b3a5-a56a126227b6\"]],null],[1,\").\"],[13],[1,\"\\n    \"],[13],[1,\"\\n    \"],[10,\"tr\"],[12],[1,\"\\n      \"],[10,\"td\"],[12],[1,\"is bestuurlijke alias van\"],[13],[1,\"\\n      \"],[10,\"td\"],[12],[8,[39,2],null,[[\"@code\"],[\"mandaat:isBestuurlijkeAliasVan\"]],null],[13],[1,\"\\n      \"],[10,\"td\"],[12],[8,[39,2],null,[[\"@code\"],[\"person:Person\"]],null],[13],[1,\"\\n      \"],[10,\"td\"],[12],[1,\"De persoon die het mandaat opneemt.\"],[13],[1,\"\\n    \"],[13],[1,\"\\n\\n  \"]],[]]]]],[1,\"\\n\"],[8,[39,0],null,[[\"@level\",\"@skin\"],[\"4\",\"4\"]],[[\"default\"],[[[[1,\"Voorbeeld\"]],[]]]]],[1,\"\\n\"],[8,[39,4],null,[[\"@snippetFilename\"],[\"mandaten-annotaties/mandataris.turtle\"]],null],[1,\"\\n\\n\"],[8,[39,0],null,[[\"@level\",\"@skin\"],[\"3\",\"3\"]],[[\"default\"],[[[[1,\"Persoon\"]],[]]]]],[1,\"\\n\"],[8,[39,0],null,[[\"@level\",\"@skin\"],[\"4\",\"4\"]],[[\"default\"],[[[[1,\"Klasse\"]],[]]]]],[1,\"\\n\"],[10,2],[12],[1,\"\\n  \"],[8,[39,2],null,[[\"@code\"],[\"person:Person\"]],null],[1,\"\\n\"],[13],[1,\"\\n\"],[8,[39,0],null,[[\"@level\",\"@skin\"],[\"4\",\"4\"]],[[\"default\"],[[[[1,\"Beschrijving\"]],[]]]]],[1,\"\\n\"],[10,2],[12],[1,\"\\n  Natuurlijk persoon. Overgenomen uit het\\n  \"],[8,[39,1],[[24,6,\"https://data.vlaanderen.be/doc/applicatieprofiel/mandatendatabank/#Persoon\"]],null,[[\"default\"],[[[[1,\"OSLO applicatieprofiel mandatendatabank\"]],[]]]]],[1,\".\\n\"],[13],[1,\"\\n\"],[8,[39,0],null,[[\"@level\",\"@skin\"],[\"4\",\"4\"]],[[\"default\"],[[[[1,\"Eigenschappen\"]],[]]]]],[1,\"\\n\"],[8,[39,3],null,null,[[\"header\",\"body\"],[[[[1,\"\\n    \"],[10,\"tr\"],[12],[1,\"\\n      \"],[10,\"th\"],[12],[1,\"Naam\"],[13],[1,\"\\n      \"],[10,\"th\"],[12],[1,\"URI\"],[13],[1,\"\\n      \"],[10,\"th\"],[12],[1,\"Verwacht type\"],[13],[1,\"\\n      \"],[10,\"th\"],[12],[1,\"Beschrijving\"],[13],[1,\"\\n    \"],[13],[1,\"\\n  \"]],[]],[[[1,\"\\n    \"],[10,\"tr\"],[12],[1,\"\\n      \"],[10,\"td\"],[12],[1,\"achternaam\"],[13],[1,\"\\n      \"],[10,\"td\"],[12],[8,[39,2],null,[[\"@code\"],[\"foaf:familyName\"]],null],[13],[1,\"\\n      \"],[10,\"td\"],[12],[8,[39,2],null,[[\"@code\"],[\"xsd:string\"]],null],[13],[1,\"\\n      \"],[10,\"td\"],[12],[1,\"De familienaam van de persoon.\"],[13],[1,\"\\n    \"],[13],[1,\"\\n    \"],[10,\"tr\"],[12],[1,\"\\n      \"],[10,\"td\"],[12],[1,\"alternatieve naam\"],[13],[1,\"\\n      \"],[10,\"td\"],[12],[8,[39,2],null,[[\"@code\"],[\"foaf:name\"]],null],[13],[1,\"\\n      \"],[10,\"td\"],[12],[8,[39,2],null,[[\"@code\"],[\"xsd:string\"]],null],[13],[1,\"\\n      \"],[10,\"td\"],[12],[1,\"Een roepnaam van de persoon. Indien aanwezig is het aan te raden deze\\n        naam te gebruiken voor visualisaties in plaats van voornaam en\\n        familienaam.\"],[13],[1,\"\\n    \"],[13],[1,\"\\n    \"],[10,\"tr\"],[12],[1,\"\\n      \"],[10,\"td\"],[12],[1,\"gebruikte voornaam\"],[13],[1,\"\\n      \"],[10,\"td\"],[12],[8,[39,2],null,[[\"@code\"],[\"persoon:gebruikteVoornaam\"]],null],[13],[1,\"\\n      \"],[10,\"td\"],[12],[8,[39,2],null,[[\"@code\"],[\"xsd:string\"]],null],[13],[1,\"\\n      \"],[10,\"td\"],[12],[1,\"De te gebruiken voornaam van alle officiële voornamen van de persoon.\"],[13],[1,\"\\n    \"],[13],[1,\"\\n  \"]],[]]]]],[1,\"\\n\"],[8,[39,0],null,[[\"@level\",\"@skin\"],[\"4\",\"4\"]],[[\"default\"],[[[[1,\"Voorbeeld\"]],[]]]]],[1,\"\\n\"],[8,[39,4],null,[[\"@snippetFilename\"],[\"mandaten-annotaties/persoon.turtle\"]],null],[1,\"\\n\"]],[],false,[\"au-heading\",\"au-link-external\",\"code-inline\",\"au-table\",\"snippet-toggle\"]]",
    "moduleName": "pages-vendors/templates/docs/mandaten-annotaties.hbs",
    "isStrictMode": false
  });
});
...
;define("pages-vendors/templates/docs/publicatie-feed", ["exports", "@ember/template-factory"], function (_exports, _templateFactory) {
  "use strict";
  ...
  */
  {
    "id": "IpjWiyaJ",
    "block": "[[[8,[39,0],null,[[\"@level\",\"@skin\"],[\"1\",\"1\"]],[[\"default\"],[[[[1,\"Publicatie Events ontsluiten via LDES\"]],[]]]]],[1,\"\\n\"],[10,2],[12],[1,\"Gepubliceerde documenten kunnen meermaals geupdated worden. Door externe systemen gerichter te laten opvragen wordt de load op de publicatieomgeving en bij de consumenten beperkt. Een Linked Data Event Stream (LDES) laat je toe om te publiceren welke URLs geupdated zijn zodat consumenten gericht komen opvragen.\"],[13],[1,\"\\n\"],[10,2],[12],[1,\"LDES is een standaardformaat wat toe laat entiteiten en wijzigingen in tijdreeksen te publiceren als een gestructureerde datastroom. In het kader van een publicatieplatform kan een LDES-feed gebruikt worden om publicaties, inclusief hun locatie, type en publicatiedatum, op een efficiënte en schaalbare manier beschikbaar te stellen. Zo kunnen systemen die Linked Data verzamelen (harvesters) eenvoudig de gepubliceerde documenten vinden op het publicatieplatform. Dit document biedt een technische introductie voor ontwikkelaars die een LDES-feed willen toevoegen aan een publicatieplatform.\"],[13],[1,\"\\n\\n\"],[8,[39,0],[[24,1,\"inhoud-van-de-feed\"]],[[\"@level\",\"@skin\"],[\"2\",\"2\"]],[[\"default\"],[[[[1,\"Inhoud van de feed\"]],[]]]]],[1,\"\\n\"],[10,2],[12],[1,\"Een LDES-feed is gebaseerd op de RDF-datastructuur en wordt meestal aangeboden via een JSON-LD of Turtle representatie. De basiscomponenten van een LDES-feed zijn:\"],[13],[1,\"\\n\"],[10,\"ul\"],[12],[1,\"\\n  \"],[10,\"li\"],[12],[8,[39,1],null,[[\"@code\"],[\"Tree:Node\"]],null],[1,\": Een subverzameling van de stream (paginering).\"],[13],[1,\"\\n  \"],[10,\"li\"],[12],[8,[39,1],null,[[\"@code\"],[\"Tree:Relation\"]],null],[1,\": Biedt links naar voorgaande of volgende pagina’s.\"],[13],[1,\"\\n  \"],[10,\"li\"],[12],[8,[39,1],null,[[\"@code\"],[\"LDES:EventStream\"]],null],[1,\": Een sequentie van wijzigingen over tijd.\"],[13],[1,\"\\n\"],[13],[1,\"\\n\\n\"],[10,2],[12],[1,\"Elke publicatie wordt als een entiteit weergegeven met minimaal:\"],[13],[1,\"\\n\"],[10,\"ul\"],[12],[1,\"\\n  \"],[10,\"li\"],[12],[8,[39,1],null,[[\"@code\"],[\"dct:isVersionOf\"]],null],[1,\": Unieke identificatie van de publicatie.\"],[13],[1,\"\\n  \"],[10,\"li\"],[12],[8,[39,1],null,[[\"@code\"],[\"prov:atLocation\"]],null],[1,\": Locatie (URL) van de publicatie.\"],[13],[1,\"\\n  \"],[10,\"li\"],[12],[8,[39,1],null,[[\"@code\"],[\"dct:type\"]],null],[1,\": Type van de publicatie, uit de \"],[8,[39,2],[[24,6,\"https://data.vlaanderen.be/doc/concept/BesluitDocumentType/\"]],null,[[\"default\"],[[[[1,\"BesluitDocumentType codelijst\"]],[]]]]],[1,\". \"],[13],[1,\"\\n  \"],[10,\"li\"],[12],[8,[39,1],null,[[\"@code\"],[\"prov:generatedAtTime\"]],null],[1,\": Publicatiedatum van het document.\"],[13],[1,\"\\n\"],[13],[1,\"\\n\\n\"],[10,2],[12],[1,\"LDES kan aangeboden worden in meerdere serializaties, in dit document gaan we uit van text/turtle serializatie, maar ook JSON-LD is mogelijk. Op het einde van het document worden er voorbeelden voorzien in beide formaten.\"],[13],[1,\"\\n\\n\"],[8,[39,0],[[24,1,\"algemene-structuur\"]],[[\"@level\",\"@skin\"],[\"3\",\"3\"]],[[\"default\"],[[[[1,\"Algemene structuur\"]],[]]]]],[1,\"\\n\"],[10,2],[12],[1,\"Een Linked Data Event Stream (LDES) (ldes:EventStream) is een verzameling (rdfs:subClassOf tree:Collection) van onveranderlijke objecten, waarbij elk object wordt beschreven met behulp van een set RDF-triples.\"],[13],[1,\"\\n\"],[8,[39,3],null,[[\"@snippetFilename\"],[\"publicatie-ldes/metadata-structure.turtle\"]],null],[1,\"\\n\"],[10,\"ul\"],[12],[1,\"\\n  \"],[10,\"li\"],[12],[8,[39,1],null,[[\"@code\"],[\"ldes:timestampPath\"]],null],[1,\" verwijst naar het predicate dat gebruikt wordt in de member om de timestamp van de data te vinden. In dit geval de publicatiedatum van het document\"],[13],[1,\"\\n  \"],[10,\"li\"],[12],[8,[39,1],null,[[\"@code\"],[\"ldes:versionOfPath\"]],null],[1,\" verwijst naar het predicate dat wordt gebruikt om te definiëren dat een tree:member van een ldes:EventStream een versie is van een rdf-document. (zie \\\"Versionering\\\")\"],[13],[1,\"\\n  \"],[10,\"li\"],[12],[8,[39,1],null,[[\"@code\"],[\"tree:shape\"]],null],[1,\" linkt naar de verwachte vorm van de members en wordt gebruikt voor validatie. Deze mag linken naar de shape gepubliceerd op TODO. Indien de feed meer data bevat dan de minimale set hier beschreven, kan ook een eigen shape gespecifieerd worden.\"],[13],[1,\"\\n  \"],[10,\"li\"],[12],[8,[39,1],null,[[\"@code\"],[\"tree:member\"]],null],[1,\" duidt op een member in de verzameling, in dit geval een gepubliceerd document.\"],[13],[1,\"\\n  \"],[10,\"li\"],[12],[8,[39,1],null,[[\"@code\"],[\"tree:view\"]],null],[1,\" Linkt naar de huidige node (pagina) in de collectie (zie fragmentering en paginering).\"],[13],[1,\"\\n\"],[13],[1,\"\\n\\n\"],[8,[39,0],[[24,1,\"fragmentering-en-paginering\"]],[[\"@level\",\"@skin\"],[\"3\",\"3\"]],[[\"default\"],[[[[1,\"Fragmentering en paginering\"]],[]]]]],[1,\"\\n\"],[10,2],[12],[1,\"Als een feed te groot wordt om in één keer op te halen, kan deze worden opgedeeld in kleinere stukken (fragmenten). Dit gebeurt volgens de \"],[8,[39,2],[[24,6,\"https://treecg.github.io/specification/\"]],null,[[\"default\"],[[[[1,\"TREE-specificatie\"]],[]]]]],[1,\", die verschillende manieren biedt om data op te splitsen en te doorzoeken. Zo kan de implementator kiezen om bijvoorbeeld publicaties in stijgende of dalende volgorde van publicatie te publiceren.\"],[13],[1,\"\\n\\n\"],[10,2],[12],[1,\"Elk individueel fragment is wederom gepubliceerd op een URL. LDES clients behandelen deze individuele documenten.  Om te weten of een pagina gewijzigd is worden de HTTP cache headers gebruikt.  Het is sterk aangewezen op een fragment wat niet meer kan wijzigen op een vaste URL te plaatsen en via HTTP Cache headers aan te geven dat het document niet meer kan wijzigen.\"],[13],[1,\"\\n\\n\"],[8,[39,0],null,[[\"@level\",\"@skin\"],[\"4\",\"4\"]],[[\"default\"],[[[[1,\"Voorbeeld in dalende volgorde (nieuwste eerst): pagina 1\"]],[]]]]],[1,\"\\n\"],[8,[39,4],null,[[\"@snippetFilename\"],[\"publicatie-ldes/fragment.turtle\"]],null],[1,\"\\n\"],[10,2],[12],[1,\"Elke pagina (\"],[8,[39,1],null,[[\"@code\"],[\"tree:Node\"]],null],[1,\") gebruikt TREE-relaties om te navigeren door de publicaties op basis van hun tijdstempel. De \"],[8,[39,1],null,[[\"@code\"],[\"tree:LessThanRelation\"]],null],[1,\" verwijst naar de volgende pagina (page=2), die events bevat met een prov:generatedAtTime kleiner dan \\\"2025-03-22T00:00:00Z\\\".\"],[13],[1,\"\\n\\n\"],[8,[39,0],null,[[\"@level\",\"@skin\"],[\"4\",\"4\"]],[[\"default\"],[[[[1,\"Voorbeeld in dalende volgorde (nieuwste eerst): pagina 2\"]],[]]]]],[1,\"\\n\"],[8,[39,4],null,[[\"@snippetFilename\"],[\"publicatie-ldes/fragment-2.turtle\"]],null],[1,\"\\n\"],[10,2],[12],[1,\"De relaties \"],[8,[39,1],null,[[\"@code\"],[\"tree:GreaterThanOrEqualToRelation\"]],null],[1,\" en \"],[8,[39,1],null,[[\"@code\"],[\"tree:LessThanRelation\"]],null],[1,\" definiëren een bereik voor page=2. In dit geval kunnen we dus publicaties met een timestamp tussen 2025-03-22T00:00:00Z en 2025-03-11T12:00:00Z verwachten op pagina 2. Voor oudere publicaties wordt verwezen naar pagina 3, voor nieuwere naar pagina 1.\"],[13],[1,\"\\n  \"],[8,[39,0],[[24,1,\"annotatie-publicaties-document-types\"]],[[\"@level\",\"@skin\"],[\"3\",\"3\"]],[[\"default\"],[[[[1,\"Versionering\"]],[]]]]],[1,\"\\n  \"],[10,2],[12],[1,\"Als een publicatie wordt geupdate, dan wordt de publicatie nogmaals op de feed gezet. Dit is een nieuwe member met eigen identifier, die naar de \\\"echte\\\" identifier linkt via de \"],[8,[39,1],null,[[\"@code\"],[\"dct:isVersionOf\"]],null],[1,\" relatie. De member krijgt dan een nieuwe \"],[8,[39,1],null,[[\"@code\"],[\"prov:generatedAtTime\"]],null],[1,\".\"],[13],[1,\"\\n  \"],[8,[39,4],null,[[\"@snippetFilename\"],[\"publicatie-ldes/version-of.turtle\"]],null],[1,\"\\n  \"],[10,2],[12],[1,\"In bovenstaande voorbeeld werd de besluitenlijst op https://vlavirgem.be/web/BesluitenLijst_Vast%20bureau_13-03-2025.html geupdate met een nieuwe versie vanwege een typfout. De publicatie staat nu 2 keer op de feed: eenmaal op de originele publicatiedatum, en eenmaal met de laatste publicatiedatum op 28 Maart 2025.\"],[13],[1,\"\\n\"],[10,2],[12],[1,\"\\n\"],[13]],[],false,[\"au-heading\",\"code-inline\",\"au-link-external\",\"snippet\",\"snippet-toggle\"]]",
    "moduleName": "pages-vendors/templates/docs/publicatie-feed.hbs",
    "isStrictMode": false
  });
});
...
;
          if (!runningTests) {
            require("pages-vendors/app")["default"].create({"name":"pages-vendors","version":"1.0.0+3be9af7e"});
          }
