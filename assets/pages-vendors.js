...
;define("pages-vendors/components/scroll-link", ["exports", "@ember/component", "@ember/template-factory", "@glimmer/component", "@ember/object"], function (_exports, _component, _templateFactory, _component2, _object) {
  "use strict";
  ...
  */
  ...
  let ScrollLinkComponent = (_class = class ScrollLinkComponent extends _component2.default {
    performScroll(event) {
...
;
          if (!runningTests) {
            require("pages-vendors/app")["default"].create({"name":"pages-vendors","version":"1.0.0+59270f74"});
          }
