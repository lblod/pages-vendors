...
<template>
  ...
  <ul>
    <li>
      <strong>Verwijs altijd naar de laatste versie.</strong>
      Het eredienstbestuur kan zijn document opnieuw indienen en het CKB kan het
      opnieuw bundelen. De
      <CodeInline>FILTER NOT EXISTS</CodeInline>
      houdt enkel de meest recente bundel per document van het eredienstbestuur
      over. Voer deze zoekopdracht opnieuw uit vlak voor je publiceert, zodat je
      besluit naar de nieuwste versie verwijst.
    </li>
    <li>
