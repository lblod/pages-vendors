...
<template>
  ...
  <p>
    ...
    melding in Loket voor Lokale Besturen. Dit document beschrijft de API voor
  ...
  <p class="au-u-para-small au-u-muted">
    Bekijk welke annotaties gebruikt kunnen worden in de gepubliceerde pagina:
    <AuLink @route="docs.meldingsplicht-annotaties">annotaties voor automatische
      melding</AuLink>.
  </p>
  <p>
    Het aanvragen van een publisher URI en geheime sleutel (key) staan verderop
    beschreven in de sectie 'Authenticatie'.
  </p>
  ...
  <AuTable>
    ...
    <:body>
      <tr>
        ...
        <td>
          <AuLinkExternal
            href="http://lblod.data.gift/concepts/79a52da4-f491-4e2f-9374-89a13cde8ecd"
          >http://lblod.data.gift/concepts/79a52da4-f491-4e2f-9374-89a13cde8ecd</AuLinkExternal>
        </td>
      </tr>
      <tr>
        <td>Inzendbaar</td>
        <td>
          <AuLinkExternal
            href="http://lblod.data.gift/concepts/f6330856-e261-430f-b949-8e510d20d0ff"
          >http://lblod.data.gift/concepts/f6330856-e261-430f-b949-8e510d20d0ff</AuLinkExternal>
        </td>
      </tr>
    </:body>
  </AuTable>
  ...
  <Snippet
    @snippetFilename="meldingsplicht/voorbeeld-body-met-draft-status.json"
  />
  ...
  <p>
    ...
    meegestuurd wordt in de automatische melding. Voor de test API kun je als
    softwareleverancier zelf een sleutel aanvragen via
    <AuLinkExternal
  ...
  <AuHeading @level="2" @skin="2" id="publicatie-documenten">Publicatie van
    documenten en besluiten</AuHeading>
  <AuHeading @level="3" @skin="3">Annotaties voor automatische melding</AuHeading>
  <p>
    Bekijk
    <AuLink @route="docs.meldingsplicht-annotaties">hier</AuLink>
    welke annotaties gebruikt kunnen worden op de gepubliceerde pagina's om
    besluiten automatisch te verzenden.
  </p>
  <AuHeading @level="3" @skin="3">Vereisten voor gepubliceerde pagina's</AuHeading>
  <p>
    Opdat de documenten en besluiten op een correcte manier automatisch geoogst
    kunnen worden, moeten de URLs waarop de documenten gepubliceerd worden aan
    enkele vereisten voldoen:
  </p>
  <AuHeading @level="4" @skin="4">SSL en certificaten</AuHeading>
  <p>
    Wanneer pagina's gepubliceerd worden met HTTPS moeten ze over een geldig
    certificaat beschikken. Dit certificaat omvat niet enkel het eigen
    certificaat, maar ook de hele keten tot aan het root-certificaat. Er bestaan
    tools, zoals
    <AuLinkExternal
      href="https://www.ssllabs.com/ssltest/index.html"
    >deze</AuLinkExternal>
    om de geldigheid van de certificaten-ketting te testen.
  </p>
  ...
  <p>
    Indien er private documenten moeten worden opgehaald, kunnen
    authenticatiegevens worden doorgegeven aan de crawler.
    <br />
    De volgende authenticatie-schemas worden ondersteund:
  </p>
  <ul>
    <li>
      <AuLinkExternal href="https://datatracker.ietf.org/doc/html/rfc7617">Basic
    ...
    <li>
      ...
      <ul>
        <li>
          ...
          >Resource Indicators</AuLinkExternal>
        </li>
      </ul>
    </li>
  </ul>
  <p>
    Deze lijst is niet definitief, en kan -in functie van de noden- uitgebreid
    worden. In geval van vragen, kan u steeds terecht op
    <AuLinkExternal
  ...
  <p>
    ...
    de melding gebeurt asynchroon, maar zou in normale omstandigheden in een
    tijdspanne van enkele minuten afgehandeld worden.
  </p>
  <p>
    Om te valideren hoe een melding er zal uitzien in het Loket van Lokale
  ...
  <AuTable>
    ...
    <:body>
      ...
      <tr>
        <td>geldig tot</td>
        <td><CodeInline @language="turtle">schema:validThrough
          </CodeInline></td>
        <td><CodeInline @language="turtle">xsd:dateTime</CodeInline></td>
      ...
      <tr>
        ...
        <td>
          ...
          <br />
          De concepten staan beschreven op
          <AuLinkExternal
            href="https://data.vlaanderen.be/doc/conceptscheme/BestuurseenheidClassificatieCode"
          >data.vlaanderen.be/doc/conceptscheme/BestuurseenheidClassificatieCode</AuLinkExternal>
        </td>
      </tr>
      <tr>
        ...
        <td><CodeInline
            @language="turtle"
          >lblodBesluit:obligationToReport</CodeInline></td>
  ...
  <p>
    ...
    <AuLinkExternal
      href="https://data.vlaanderen.be/id/concept/BesluitDocumentType/"
    >BesluitDocumentType</AuLinkExternal>
    en
    <AuLinkExternal
      href="https://data.vlaanderen.be/id/concept/BesluitType/"
    >BesluitType</AuLinkExternal>
    worden gelinkt met het predikaat
    <AuLinkExternal
      href="http://lblod.data.gift/vocabularies/besluit/"
    >lblodBesluit:notificationRule</AuLinkExternal>
    om te verwijzen naar de specifieke regels die van toepassing op het type
    besluit.
  </p>
  <AuHeading @level="4" @skin="4">Eigenschappen</AuHeading>
  <AuTable>
    ...
    <:body>
      <tr>
        ...
        <td><CodeInline
            @language="turtle"
          >lblodBesluit:notificationRule</CodeInline></td>
        <td><CodeInline
            @language="turtle"
          >rule:NotificationRule</CodeInline></td>
