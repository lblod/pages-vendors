...
<template>
  ...
  <p>
    Momenteel host
    <AuLinkExternal href="https://centrale-vindplaats.lblod.info">
      https://centrale-vindplaats.lblod.info</AuLinkExternal>
    alle data die beschikbaar is op
    <AuLinkExternal href="https://mandaten.lokaalbestuur.vlaanderen.be/">
      https://mandaten.lokaalbestuur.vlaanderen.be</AuLinkExternal>
    en
    <AuLinkExternal href="https://leidinggevenden.lokaalbestuur.vlaanderen.be/">
      https://leidinggevenden.lokaalbestuur.vlaanderen.be</AuLinkExternal>.
  </p>
  ...
  <AuHeading @level="3" @skin="3">Lijst alle bestuursorganen (in bestuursperiode
    op)</AuHeading>
  <p>
  ...
  <AuHeading @level="3" @skin="3">Lijst van alle mandaten, en de bijbehorende
    personen</AuHeading>
  <Snippet
    @snippetFilename="centrale-vindplaats-sparql/mandaten-en-personen.sparql"
  />

  <AuHeading @level="3" @skin="3">Overzicht van leidinggevenden per
    bestuurseenheid</AuHeading>
  <Snippet
    @snippetFilename="centrale-vindplaats-sparql/leidinggevenden-per-bestuurseenheid.sparql"
  />
