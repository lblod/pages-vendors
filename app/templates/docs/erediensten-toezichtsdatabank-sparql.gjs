...
<template>
  {{pageTitle "Erediensten Toezichtsdatabank SPARQL API"}}
  <AuHeading @skin="1" @level="1">Erediensten Toezichtsdatabank SPARQL API
...
https://databankerediensten.lokaalbestuur.vlaanderen.be/vendor/logout
  ...
  <p>
    Dit eerste eenvoudige voorbeeld geeft een korte lijst van een aantal
    willekeurige inzendingen (Submissions); een query voor het ontdekken van een
    aantal URI's die in volgende query's gebruikt kunnen worden.
  </p>
  <Snippet
    @snippetFilename="eredienst-toezichtsdatabank-sparql/voorbeeld-willekeurige-lijst.sparql"
  />
  ...
  <Snippet
    @snippetFilename="eredienst-toezichtsdatabank-sparql/voorbeeld-submissions-in-maart.sparql"
  />

  <p>
    Om te zoeken naar alle Submissions van een bepaald type van publicatie kan
    inspiratie gehaald worden uit volgend voorbeeld. Dit kan gecombineerd worden
    met een filter op creatiedatum bijvoorbeeld of met een invulling van de
    bestuurseenheid om enkel over een bepaalde bestuurseenheid te zoeken.
  </p>
  <Snippet
    @snippetFilename="eredienst-toezichtsdatabank-sparql/voorbeeld-documenttype.sparql"
  />

  <AuHeading @level="3" @skin="3">Opvragen van details - Voorbeelden</AuHeading>
  <p>
    Om in detail alle informatie over een Submission, de formuliergegevens
    (FormData) en alle gelinkte bestanden te bekomen kan een query als de
    onderstaande gebruikt worden.
  </p>
  <Snippet
    @snippetFilename="eredienst-toezichtsdatabank-sparql/voorbeeld-construct.sparql"
  />
  <p>
  ...
  <p>
    Om voor een bepaalde Submission een lijst te krijgen van alle gelinkte
    bestanden van de formuliergegevens, gebruik het onderstaande voorbeeld.
  </p>
  <Snippet
    @snippetFilename="eredienst-toezichtsdatabank-sparql/voorbeeld-downloadlink.sparql"
  />
  <p>
  ...
  />
  <SnippetToggle
    @snippetFilename="eredienst-toezichtsdatabank-sparql/voorbeeld-gelinkte-documenten-gemeente-extra.sparql"
  />
  ...
  <Snippet
    @snippetFilename="eredienst-toezichtsdatabank-sparql/voorbeeld-gelinkte-documenten-CKB.sparql"
  />
  <SnippetToggle
    @snippetFilename="eredienst-toezichtsdatabank-sparql/voorbeeld-gelinkte-documenten-CKB-extra.sparql"
  />
  ...
  <a
    ...
    href="assets/diagrams/erediensten-toezichtsdatabank-sparql.svg"
  >
    <figure>
      <img
        itemprop="thumbnail"
        src="assets/diagrams/erediensten-toezichtsdatabank-sparql.svg"
  ...
  <p>
    ...
    refereert in feite naar het ingezonden document.
  </p>
  <AuHeading @level="4" @skin="4">Eigenschappen</AuHeading>
  <AuTable>
    <:header>
  ...
  <p>
    ...
    naar artikels van een eredienstbestuur.
  </p>
  <AuHeading @level="4" @skin="4">Eigenschappen</AuHeading>
  <AuTable>
    <:header>
