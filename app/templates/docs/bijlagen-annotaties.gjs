...
<template>
  ...
  <Snippet
    @snippetFilename="bijlagen-annotaties/voorbeeld-besluit-met-pdf-bijlage.html"
  />
  ...
  <p>
    In het onderstaande voorbeeld wordt een subsidiereglement goedgekeurd, het
    reglement wordt als tweede besluit opgenomen in de behandeling van het
    agendapunt.
  </p>
  <ul>
    <li>
  ...
  <Snippet
    @snippetFilename="bijlagen-annotaties/voorbeeld-besluit-met-geannoteerde-bijlage.html"
  />
</template>
